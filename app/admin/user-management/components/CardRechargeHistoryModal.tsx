...
interface CardRechargeHistoryModalProps {
  isOpen: boolean
  onClose: () => void
  playerId: string
}

export default function CardRechargeHistoryModal({
  isOpen,
  onClose,
  playerId,
}: CardRechargeHistoryModalProps) {
  ...
  useEffect(() => {
    const fetchRechargeHistory = async () => {
      ...
      setLoading(true)
      try {
        const response = await apiGet(`/api/players/${playerId}/recharge-history`)
        if (response.ok) {
