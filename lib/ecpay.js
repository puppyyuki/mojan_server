...
function createEcpayPaymentData(
  ...
  const basePaymentData = {
    ...
    // Flutter Web 應用的路由
    // 使用 #/shop 確保返回商店頁面（Flutter Web 使用 HashRouter）
    ClientBackURL: `${frontBase}#/shop`,  // 返回商店頁面
    OrderResultURL: `${frontBase}#/shop`,  // 返回商店頁面
    // 只使用 ATM，隱藏其他付款方式
    IgnorePayment: 'Credit#AndroidPay#GooglePay#WebATM#ApplePay#CVS#BARCODE',
    EncryptType: 1,
  };
